...
# Nodepool to consume reservation for VM instances
...
# Nodepool to spill over high priority workloads from reserved to on-demand instances
...
# Nodepool to spill over low priority workloads from reserved to Spot instances
